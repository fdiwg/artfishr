accuracy_plot<-function(sample=NULL,population){

data<-do.call("rbind",lapply(1:population,function(i){data.frame(x=i,y=artfish_accuracy(n=i,N=population,method="higher"))}))
