#'@name artfish_estimates_by_fleet_segment
#'@title artfish_estimates_by_fleet_segment
#'
...
#'@export
#'
artfish_estimates_by_fleet_segment <- function(
  ...
  group_cols = c("EST_YEAR","EST_MONTH","EST_BGC","EST_FS")
  ...
  effort <- data_effort|>
    ...
    dplyr::summarise(
      ...
      mean = base::mean(.data$days_sampled, na.rm=T),
  ...
  estimate <- data_landing |>
    ...
    dplyr::select(-c("ratio","EST_LND_CPUE_G"))
