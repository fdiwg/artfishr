...
#'@title Generates a \link[tibble]{tibble} of active days.
...
#'@return an object of class \link[tibble]{tibble} give active days
#'@export
...
#'in the period will be auto-generated
#'@param active_days active days object of class \link[tibble]{tibble}
