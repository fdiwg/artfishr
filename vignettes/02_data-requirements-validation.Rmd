...
1. **Fisher interviews (`effort_source = "fisher_interview"`)**  
   ...
   - The template `effort_fisher_interview.csv` is required (number of days fished within the period of reference)
...
2. **Boat counting (`effort_source = "boat_counting"`)**  
   ...
   - Template `effort_boat_counting.csv` is required (number of boats out in comparison of total potentially active boat)
