---
title: Introduction to artfishr package for artisanal fishery statistics
...
This vignette shows how to use [artfishr](https://github.com/fdiwg/artfishr) R package.
