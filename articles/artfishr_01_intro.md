...
procedures, see:
[`vignette("artfishr_02_data-requirements-validation")`](https://fdiwg.github.io/artfishr/articles/artfishr_02_data-requirements-validation.md)

## Using `artfishr` for Small-Scale Fisheries Estimation

Full tutorial:
[`vignette("artfishr_03_workflow")`](https://fdiwg.github.io/artfishr/articles/artfishr_03_workflow.md)

## Statistical framework of the ARTFISH methodology

See:
[`vignette("artfishr_04_methodology")`](https://fdiwg.github.io/artfishr/articles/artfishr_04_methodology.md)

## Artfish visualisations

See:
[`vignette("artfishr_05_visualisation")`](https://fdiwg.github.io/artfishr/articles/artfishr_05_visualisation.md)
...
effort <- read.csv(system.file("extdata/samples/effort_fisher_interview.csv", package = "artfishr"))
