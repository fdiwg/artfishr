...
1.  **Fisher interviews (`effort_source = "fisher_interview"`)**
    ...
    - The template `effort.csv` is required (number of days fished
      within the period of reference) corresponding to the tab B1.
      Effort (fisher interviews) of the Excel template
...
2.  **Boat counting (`effort_source = "boat_counting"`)**
    - Data is obtained by direct observation on sampled days. Data
      ...
      sampled day.
    - Template `effort.csv` is required (number of boats out in
      comparison of total potentially active boat) corresponding to the
      tab B2. Effoet (boat counting) of the Excel template
